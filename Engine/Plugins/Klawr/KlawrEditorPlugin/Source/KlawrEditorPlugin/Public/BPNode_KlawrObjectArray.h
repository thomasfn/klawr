...
#pragma once
#include "K2Node.h"
#include "BPNode_KlawrObjectArray.generated.h"

UCLASS(MinimalAPI)
class UBPNode_KlawrObjectArray : public UK2Node
{
...
protected:
	...
	UFunction* GetArrayClearFunction() const;

	/** Returns the function to be used to add a function to the array */
	UFunction* GetArrayAddFunction() const;
};
